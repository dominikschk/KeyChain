...
const messages = {
  de: {
    ...
    'save.step.done': 'Weiter zur Kasse…',
    'handoff.title': 'Bereit für die Bestellung',
    'handoff.sub': 'Als Nächstes öffnet die Kasse mit deinem Preis. Links stehen auch in der Bestellmail.',
  ...
  en: {
    ...
    'save.step.done': 'Opening checkout…',
    'handoff.title': 'Ready to order',
    'handoff.sub': 'Next: checkout with your price. Links are also in the order email.',
